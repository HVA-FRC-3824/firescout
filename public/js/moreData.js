function kidnap(newUrl) {
    ...
    $.ajax({
        ...
        headers: {
            'X-TBA-Auth-Key': 'ZsBo7pJNXNffiaz7RQmC4WgA8e8ATyex840UH45GwikuN86086uIfw57rvkJ7CLC' //This header contains Evan Boswell's Blue Alliance authentication key, this will need to be changed for years beyond 2019/2020
        },
